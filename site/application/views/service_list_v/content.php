    ...
    <div class="container">
        <div class="row">
            ...
            <div class="main col-12">
                ...
                <!-- page-title start -->
                <!-- ================ -->
                <h1 class="page-title">Our Social Responsibility Projects</h1>
                            ...
                            <?php if(($index % 2) == 0) { ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="overlay-container">
                                        <img src="<?php echo base_url("panel/uploads/services_v/$service->img_url");?>" alt="<?php echo $service->title; ?>" class="center-block">

        ...
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div id="slider-banner-boxedwidth" class="slider-banner-boxedwidth rev_slider" data-version="5.0">
                                    <ul class="slides">
                                        <?php foreach ($product_images as $image) { ?>
                                            ...
                                            <!-- main image -->
                                            <img src="<?php echo base_url("panel/uploads/product_v/$image->image_url");?>" alt="<?php echo $product->title; ?>" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                                            ...
                                            <div class="tp-caption large_white"
                                                 ...
                                                 data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><?php echo $product->title; ?>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="main col-md-12">
                                ...
                                <blockquote class="margin-clear">
                                    <footer><cite<div class="copyright pull-left">All right reserved | D|E darendeli 2021 ©</div></cite></footer>
                                </blockquote>
                            </div>
                            <!-- main end -->
                        </div>
                ...
                <section class="section light-gray-bg  pv-40 clearfix">
                    <div class="container">
                        <h3><Other></Other> <strong>Other Products</strong></h3>
